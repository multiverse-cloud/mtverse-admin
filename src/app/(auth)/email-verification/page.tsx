    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-950">
      <div className="w-full max-w-md px-4">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-8 dark:border-white/5 dark:bg-gray-dark">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white/90">Email Verification</h2>
          ...
          <div className="mt-6 space-y-4">
            ...
            <button className="w-full rounded-lg bg-brand-500 py-3 text-sm font-semibold text-white hover:bg-brand-600">Email Verification</button>
          </div>
        </div>
      </div>
    </div>
