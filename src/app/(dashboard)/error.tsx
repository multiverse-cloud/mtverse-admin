  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center p-6">
      <div className="w-full max-w-lg text-center">
        {/* Error icon */}
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-lg bg-red-50 dark:bg-red-500/10">
        ...
        <p className="mt-3 text-sm text-gray-500 dark:text-gray-400">
          An unexpected error occurred while loading this dashboard. This could
          be a temporary issue. Please try again or navigate back.
        </p>
