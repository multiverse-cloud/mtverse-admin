...
export const revealcardSource: ComponentSourceData = {
  component: 'Reveal Card',
  slug: 'reveal-card',
  category: 'Advanced UI',
  categorySlug: 'advanced-ui',
  description: 'Card with reveal animation on hover or scroll for hidden content or details.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'RevealCard.tsx',
...
export default function RevealCard() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Card with reveal animation on hover or scroll for hidden content or details.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'reveal-card/page.tsx',
      code: `'use client';

import RevealCard from '@/components/mtverse/advanced-ui/RevealCard';
...
export default function RevealCardPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'RevealCard.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Card with reveal animation on hover or scroll for hidden content or details.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'reveal-card.component.ts',
...
<div x-data="{ isActive: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <button
    ...
    laravel: {
      language: 'blade',
      filename: 'reveal-card.blade.php',
