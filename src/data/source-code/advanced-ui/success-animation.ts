...
export const successanimationSource: ComponentSourceData = {
  component: 'Success Animation',
  slug: 'success-animation',
  category: 'Advanced UI',
  categorySlug: 'advanced-ui',
  description: 'Celebratory checkmark animation for success states and confirmations.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'SuccessAnimation.tsx',
...
export default function SuccessAnimation() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Celebratory checkmark animation for success states and confirmations.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'success-animation/page.tsx',
      code: `'use client';

import SuccessAnimation from '@/components/mtverse/advanced-ui/SuccessAnimation';
...
export default function SuccessAnimationPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'SuccessAnimation.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Celebratory checkmark animation for success states and confirmations.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'success-animation.component.ts',
...
export class SuccessAnimationComponent {
  ...
  toggle() { this.isActive = !this.isActive; }
    ...
    html: {
      language: 'html',
      filename: 'success-animation.html',
      code: `<!-- HTML + Alpine.js -->
<div x-data="{ isActive: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <button
    ...
    laravel: {
      language: 'blade',
      filename: 'success-animation.blade.php',
