...
export const gradienttextSource: ComponentSourceData = {
  ...
  description: 'Text with animated gradient that shifts colors smoothly across the content.',
  sources: {
    react: {
      language: 'tsx',
...
export default function GradientText() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Text with animated gradient that shifts colors smoothly across the content.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'gradient-text/page.tsx',
      code: `'use client';

import GradientText from '@/components/mtverse/advanced-ui/GradientText';
...
export default function GradientTextPage() {
  ...
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Text with animated gradient that shifts colors smoothly across the content.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'gradient-text.component.ts',
...
<div x-data="{ isActive: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <button
    ...
    laravel: {
      language: 'blade',
      filename: 'gradient-text.blade.php',
