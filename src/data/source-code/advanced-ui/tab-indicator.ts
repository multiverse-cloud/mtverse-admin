...
export const tabindicatorSource: ComponentSourceData = {
  component: 'Tab Indicator',
  slug: 'tab-indicator',
  category: 'Advanced UI',
  categorySlug: 'advanced-ui',
  description: 'Animated tab indicator that slides smoothly between active tabs.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'TabIndicator.tsx',
...
export default function TabIndicator() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Animated tab indicator that slides smoothly between active tabs.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'tab-indicator/page.tsx',
      code: `'use client';

import TabIndicator from '@/components/mtverse/advanced-ui/TabIndicator';

export default function TabIndicatorPage() {
  return (
    <div className="p-6">
      <TabIndicator />
    </div>
    ...
    vue: {
      language: 'vue',
      filename: 'TabIndicator.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Animated tab indicator that slides smoothly between active tabs.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'tab-indicator.component.ts',
...
<div x-data="{ isActive: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <button
    ...
    laravel: {
      language: 'blade',
      filename: 'tab-indicator.blade.php',
