...
export const lightboxSource: ComponentSourceData = {
  component: 'Lightbox',
  slug: 'lightbox',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Image lightbox overlay with zoom, navigation arrows, and keyboard controls.',
  sources: {
    react: {
      language: 'tsx',
...
export default function Lightbox() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Image lightbox overlay with zoom, navigation arrows, and keyboard controls.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'lightbox/page.tsx',
      code: `'use client';

import Lightbox from '@/components/mtverse/extended-ui/Lightbox';
...
export default function LightboxPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'Lightbox.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Image lightbox overlay with zoom, navigation arrows, and keyboard controls.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'lightbox.component.ts',
