...
export const metricGaugeSource: ComponentSourceData = {
  component: 'MetricGauge',
  slug: 'metric-gauge',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Gauge/speedometer display with SVG arc and adjustable value.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'MetricGauge.tsx',
...
export default function MetricGauge() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">MetricGauge component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'metric-gauge/page.tsx',
      code: `'use client';

import MetricGauge from '@/components/mtverse/extended-ui/MetricGauge';

export default function MetricGaugePage() {
  return <MetricGauge />;
}`,
    },
    vue: {
      language: 'vue',
      filename: 'MetricGauge.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">MetricGauge component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'metric-gauge.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'metric-gauge.blade.php',
