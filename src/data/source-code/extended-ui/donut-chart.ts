...
export const donutChartSource: ComponentSourceData = {
  component: 'DonutChart',
  slug: 'donut-chart',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Simple donut chart visualization with legend and hover interaction.',
  sources: {
    react: {
      language: 'tsx',
...
export default function DonutChart() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">DonutChart component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'donut-chart/page.tsx',
      code: `'use client';

import DonutChart from '@/components/mtverse/extended-ui/DonutChart';
...
export default function DonutChartPage() {
  return <DonutChart />;
    ...
    vue: {
      language: 'vue',
      filename: 'DonutChart.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">DonutChart component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'donut-chart.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'donut-chart.blade.php',
