...
export const profileCardSource: ComponentSourceData = {
  component: 'ProfileCard',
  slug: 'profile-card',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'User profile card with stats and follow button.',
  sources: {
    react: {
      language: 'tsx',
...
export default function ProfileCard() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">ProfileCard component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'profile-card/page.tsx',
      code: `'use client';

import ProfileCard from '@/components/mtverse/extended-ui/ProfileCard';
...
export default function ProfileCardPage() {
  ...
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">ProfileCard component</p>
    <button
      @click="active = !active"
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'profile-card.blade.php',
