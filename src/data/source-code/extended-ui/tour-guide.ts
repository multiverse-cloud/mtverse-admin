...
export const tourguideSource: ComponentSourceData = {
  component: 'Tour Guide',
  slug: 'tour-guide',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Interactive product tour with step-by-step highlights and navigation.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'TourGuide.tsx',
...
export default function TourGuide() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Interactive product tour with step-by-step highlights and navigation.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'tour-guide/page.tsx',
      code: `'use client';

import TourGuide from '@/components/mtverse/extended-ui/TourGuide';
...
export default function TourGuidePage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'TourGuide.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Interactive product tour with step-by-step highlights and navigation.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'tour-guide.component.ts',
