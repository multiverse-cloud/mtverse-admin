...
export const searchResultsSource: ComponentSourceData = {
  component: 'SearchResults',
  slug: 'search-results',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Search results display with keyword highlighting and URLs.',
  sources: {
    react: {
      language: 'tsx',
...
export default function SearchResults() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">SearchResults component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'search-results/page.tsx',
      code: `'use client';

import SearchResults from '@/components/mtverse/extended-ui/SearchResults';
...
export default function SearchResultsPage() {
  return <SearchResults />;
    ...
    vue: {
      language: 'vue',
      filename: 'SearchResults.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">SearchResults component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'search-results.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'search-results.blade.php',
