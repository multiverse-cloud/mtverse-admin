...
export const qrcodeSource: ComponentSourceData = {
  component: 'QR Code',
  slug: 'qr-code',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'QR code display component with configurable size and download option.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'QrCode.tsx',
...
export default function QrCode() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">QR code display component with configurable size and download option.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'qr-code/page.tsx',
      code: `'use client';

import QrCode from '@/components/mtverse/extended-ui/QrCode';
...
export default function QrCodePage() {
  ...
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">QR code display component with configurable size and download option.</p>
    <button
