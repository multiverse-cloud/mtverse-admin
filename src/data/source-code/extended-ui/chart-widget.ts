...
export const chartwidgetSource: ComponentSourceData = {
  component: 'Chart Widget',
  slug: 'chart-widget',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Compact chart widget with sparkline visualization and trend indicators.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'ChartWidget.tsx',
...
export default function ChartWidget() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Compact chart widget with sparkline visualization and trend indicators.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'chart-widget/page.tsx',
      code: `'use client';

import ChartWidget from '@/components/mtverse/extended-ui/ChartWidget';
...
export default function ChartWidgetPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'ChartWidget.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Compact chart widget with sparkline visualization and trend indicators.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'chart-widget.component.ts',
...
<div x-data="{ isActive: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <button
    ...
    laravel: {
      language: 'blade',
      filename: 'chart-widget.blade.php',
