...
export const progressDashboardSource: ComponentSourceData = {
  component: 'ProgressDashboard',
  slug: 'progress-dashboard',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Multi-metric progress dashboard with targets and bars.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'ProgressDashboard.tsx',
...
export default function ProgressDashboard() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">ProgressDashboard component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'progress-dashboard/page.tsx',
      code: `'use client';

import ProgressDashboard from '@/components/mtverse/extended-ui/ProgressDashboard';
...
export default function ProgressDashboardPage() {
  return <ProgressDashboard />;
    ...
    vue: {
      language: 'vue',
      filename: 'ProgressDashboard.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">ProgressDashboard component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'progress-dashboard.component.ts',
...
export class ProgressDashboardComponent {
  active = false;
    ...
    html: {
      language: 'html',
      filename: 'progress-dashboard.html',
      code: `<!-- HTML + Alpine.js -->
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'progress-dashboard.blade.php',
