...
export const infobannerSource: ComponentSourceData = {
  component: 'Info Banner',
  slug: 'info-banner',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Informational banner with icon, dismiss button, and optional action link.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'InfoBanner.tsx',
...
export default function InfoBanner() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Informational banner with icon, dismiss button, and optional action link.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'info-banner/page.tsx',
      code: `'use client';

import InfoBanner from '@/components/mtverse/extended-ui/InfoBanner';
...
export default function InfoBannerPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'InfoBanner.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Informational banner with icon, dismiss button, and optional action link.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'info-banner.component.ts',
...
<div x-data="{ isActive: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <button
    ...
    laravel: {
      language: 'blade',
      filename: 'info-banner.blade.php',
