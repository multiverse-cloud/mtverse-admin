...
export const videoPlayerSource: ComponentSourceData = {
  component: 'VideoPlayer',
  slug: 'video-player',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Custom video player with controls overlay and fullscreen toggle.',
  sources: {
    react: {
      language: 'tsx',
...
export default function VideoPlayer() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">VideoPlayer component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'video-player/page.tsx',
      code: `'use client';

import VideoPlayer from '@/components/mtverse/extended-ui/VideoPlayer';
...
export default function VideoPlayerPage() {
  return <VideoPlayer />;
    ...
    vue: {
      language: 'vue',
      filename: 'VideoPlayer.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">VideoPlayer component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'video-player.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'video-player.blade.php',
