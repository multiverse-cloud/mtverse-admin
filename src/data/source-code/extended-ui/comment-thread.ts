...
export const commentThreadSource: ComponentSourceData = {
  component: 'CommentThread',
  slug: 'comment-thread',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Nested comment thread with replies and reply input.',
  sources: {
    react: {
      language: 'tsx',
...
export default function CommentThread() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">CommentThread component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'comment-thread/page.tsx',
      code: `'use client';

import CommentThread from '@/components/mtverse/extended-ui/CommentThread';
...
export default function CommentThreadPage() {
  return <CommentThread />;
    ...
    vue: {
      language: 'vue',
      filename: 'CommentThread.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">CommentThread component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'comment-thread.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'comment-thread.blade.php',
