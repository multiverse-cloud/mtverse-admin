...
export const warningbannerSource: ComponentSourceData = {
  component: 'Warning Banner',
  slug: 'warning-banner',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Warning notification banner with severity levels and dismiss option.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'WarningBanner.tsx',
...
export default function WarningBanner() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Warning notification banner with severity levels and dismiss option.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'warning-banner/page.tsx',
      code: `'use client';

import WarningBanner from '@/components/mtverse/extended-ui/WarningBanner';
...
export default function WarningBannerPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'WarningBanner.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Warning notification banner with severity levels and dismiss option.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'warning-banner.component.ts',
...
<div x-data="{ isActive: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <button
    ...
    laravel: {
      language: 'blade',
      filename: 'warning-banner.blade.php',
