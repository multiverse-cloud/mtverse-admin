...
export const filelistSource: ComponentSourceData = {
  component: 'File List',
  slug: 'file-list',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Sortable file list with file type icons, size display, and action buttons.',
  sources: {
    react: {
      language: 'tsx',
...
export default function FileList() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Sortable file list with file type icons, size display, and action buttons.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'file-list/page.tsx',
      code: `'use client';

import FileList from '@/components/mtverse/extended-ui/FileList';
...
export default function FileListPage() {
  ...
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Sortable file list with file type icons, size display, and action buttons.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'file-list.component.ts',
