...
export const chartPlaceholderSource: ComponentSourceData = {
  component: 'ChartPlaceholder',
  slug: 'chart-placeholder',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Chart display area with bar visualization and legend.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'ChartPlaceholder.tsx',
...
export default function ChartPlaceholder() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">ChartPlaceholder component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'chart-placeholder/page.tsx',
      code: `'use client';

import ChartPlaceholder from '@/components/mtverse/extended-ui/ChartPlaceholder';

export default function ChartPlaceholderPage() {
  return <ChartPlaceholder />;
}`,
    },
    vue: {
      language: 'vue',
      filename: 'ChartPlaceholder.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">ChartPlaceholder component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'chart-placeholder.component.ts',
...
export class ChartPlaceholderComponent {
  active = false;
    ...
    html: {
      language: 'html',
      filename: 'chart-placeholder.html',
      code: `<!-- HTML + Alpine.js -->
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'chart-placeholder.blade.php',
