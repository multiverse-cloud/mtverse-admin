...
export const notificationPanelSource: ComponentSourceData = {
  component: 'NotificationPanel',
  slug: 'notification-panel',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Notification list with categories, read status, and mark-all-read.',
  sources: {
    react: {
      language: 'tsx',
...
export default function NotificationPanel() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">NotificationPanel component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'notification-panel/page.tsx',
      code: `'use client';

import NotificationPanel from '@/components/mtverse/extended-ui/NotificationPanel';
...
export default function NotificationPanelPage() {
  return <NotificationPanel />;
    ...
    vue: {
      language: 'vue',
      filename: 'NotificationPanel.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">NotificationPanel component</p>
    <button
      @click="active = !active"
...
export class NotificationPanelComponent {
  active = false;
    ...
    html: {
      language: 'html',
      filename: 'notification-panel.html',
      code: `<!-- HTML + Alpine.js -->
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'notification-panel.blade.php',
