...
export const audioPlayerSource: ComponentSourceData = {
  component: 'AudioPlayer',
  slug: 'audio-player',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Music player with play/pause, progress bar, and volume controls.',
  sources: {
    react: {
      language: 'tsx',
...
export default function AudioPlayer() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">AudioPlayer component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'audio-player/page.tsx',
      code: `'use client';

import AudioPlayer from '@/components/mtverse/extended-ui/AudioPlayer';
...
export default function AudioPlayerPage() {
  return <AudioPlayer />;
    ...
    vue: {
      language: 'vue',
      filename: 'AudioPlayer.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">AudioPlayer component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'audio-player.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'audio-player.blade.php',
