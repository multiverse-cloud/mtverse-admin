...
export const tagManagerSource: ComponentSourceData = {
  component: 'TagManager',
  slug: 'tag-manager',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Drag and drop tag management with add and remove capabilities.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'TagManager.tsx',
...
export default function TagManager() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">TagManager component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'tag-manager/page.tsx',
      code: `'use client';

import TagManager from '@/components/mtverse/extended-ui/TagManager';
...
export default function TagManagerPage() {
  return <TagManager />;
    ...
    vue: {
      language: 'vue',
      filename: 'TagManager.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">TagManager component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'tag-manager.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'tag-manager.blade.php',
