...
export const wizardnavSource: ComponentSourceData = {
  component: 'Wizard Navigation',
  slug: 'wizard-nav',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Multi-step wizard navigation with progress tracking and step validation.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'WizardNav.tsx',
...
export default function WizardNav() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Multi-step wizard navigation with progress tracking and step validation.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'wizard-nav/page.tsx',
      code: `'use client';

import WizardNav from '@/components/mtverse/extended-ui/WizardNav';
...
export default function WizardNavPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'WizardNav.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Multi-step wizard navigation with progress tracking and step validation.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'wizard-nav.component.ts',
