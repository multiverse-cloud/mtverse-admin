...
export const stockTickerSource: ComponentSourceData = {
  component: 'StockTicker',
  slug: 'stock-ticker',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Live stock price ticker with trend arrows and change percentages.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'StockTicker.tsx',
...
export default function StockTicker() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">StockTicker component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'stock-ticker/page.tsx',
      code: `'use client';

import StockTicker from '@/components/mtverse/extended-ui/StockTicker';
...
export default function StockTickerPage() {
  return <StockTicker />;
    ...
    vue: {
      language: 'vue',
      filename: 'StockTicker.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">StockTicker component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'stock-ticker.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'stock-ticker.blade.php',
