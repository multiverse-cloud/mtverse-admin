...
export const productCardSource: ComponentSourceData = {
  component: 'ProductCard',
  slug: 'product-card',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'E-commerce product card with cart button, rating, and pricing.',
  sources: {
    react: {
      language: 'tsx',
...
export default function ProductCard() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">ProductCard component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'product-card/page.tsx',
      code: `'use client';

import ProductCard from '@/components/mtverse/extended-ui/ProductCard';
...
export default function ProductCardPage() {
  ...
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">ProductCard component</p>
    <button
      @click="active = !active"
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'product-card.blade.php',
