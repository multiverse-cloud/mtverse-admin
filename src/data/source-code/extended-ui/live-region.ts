...
export const liveregionSource: ComponentSourceData = {
...
export default function LiveRegion() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">ARIA live region component for announcing dynamic content changes to screen readers.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'live-region/page.tsx',
      code: `'use client';

import LiveRegion from '@/components/mtverse/extended-ui/LiveRegion';
...
export default function LiveRegionPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'LiveRegion.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">ARIA live region component for announcing dynamic content changes to screen readers.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'live-region.component.ts',
...
<div x-data="{ isActive: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <button
    ...
    laravel: {
      language: 'blade',
      filename: 'live-region.blade.php',
