...
export const kanbanBoardSource: ComponentSourceData = {
  component: 'KanbanBoard',
  slug: 'kanban-board',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Mini kanban board with columns for task management.',
  sources: {
    react: {
      language: 'tsx',
...
export default function KanbanBoard() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">KanbanBoard component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'kanban-board/page.tsx',
      code: `'use client';

import KanbanBoard from '@/components/mtverse/extended-ui/KanbanBoard';
...
export default function KanbanBoardPage() {
  return <KanbanBoard />;
    ...
    vue: {
      language: 'vue',
      filename: 'KanbanBoard.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">KanbanBoard component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'kanban-board.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'kanban-board.blade.php',
