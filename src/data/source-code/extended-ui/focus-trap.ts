...
export const focustrapSource: ComponentSourceData = {
  component: 'Focus Trap',
  slug: 'focus-trap',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Accessibility focus trap component that confines keyboard navigation within a container.',
  sources: {
    react: {
      language: 'tsx',
...
export default function FocusTrap() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Accessibility focus trap component that confines keyboard navigation within a container.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'focus-trap/page.tsx',
      code: `'use client';

import FocusTrap from '@/components/mtverse/extended-ui/FocusTrap';
...
export default function FocusTrapPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'FocusTrap.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Accessibility focus trap component that confines keyboard navigation within a container.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'focus-trap.component.ts',
