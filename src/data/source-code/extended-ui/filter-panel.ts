...
export const filterPanelSource: ComponentSourceData = {
  component: 'FilterPanel',
  slug: 'filter-panel',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Advanced filter panel with category, price range, and rating facets.',
  sources: {
    react: {
      language: 'tsx',
...
export default function FilterPanel() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">FilterPanel component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'filter-panel/page.tsx',
      code: `'use client';

import FilterPanel from '@/components/mtverse/extended-ui/FilterPanel';
...
export default function FilterPanelPage() {
  return <FilterPanel />;
    ...
    vue: {
      language: 'vue',
      filename: 'FilterPanel.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">FilterPanel component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'filter-panel.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'filter-panel.blade.php',
