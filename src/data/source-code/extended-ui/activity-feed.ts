...
export const activityFeedSource: ComponentSourceData = {
  component: 'ActivityFeed',
  slug: 'activity-feed',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Activity timeline feed with color-coded events.',
  sources: {
    react: {
      language: 'tsx',
...
export default function ActivityFeed() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
      <p className="text-sm text-gray-700 dark:text-gray-300">ActivityFeed component</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'activity-feed/page.tsx',
      code: `'use client';

import ActivityFeed from '@/components/mtverse/extended-ui/ActivityFeed';
...
export default function ActivityFeedPage() {
  return <ActivityFeed />;
    ...
    vue: {
      language: 'vue',
      filename: 'ActivityFeed.vue',
      code: `<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">ActivityFeed component</p>
    <button
      @click="active = !active"
...
const active = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'activity-feed.component.ts',
...
<div x-data="{ active: false }" class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/5 dark:bg-gray-800">
  ...
  ></button>
    ...
    laravel: {
      language: 'blade',
      filename: 'activity-feed.blade.php',
