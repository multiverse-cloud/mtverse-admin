...
export const skiplinkSource: ComponentSourceData = {
  component: 'Skip Link',
  slug: 'skip-link',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Skip navigation link for keyboard users to bypass repetitive content.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'SkipLink.tsx',
...
export default function SkipLink() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Skip navigation link for keyboard users to bypass repetitive content.</p>
      <button
...
import SkipLink from '@/components/mtverse/extended-ui/SkipLink';
...
export default function SkipLinkPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'SkipLink.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Skip navigation link for keyboard users to bypass repetitive content.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'skip-link.component.ts',
