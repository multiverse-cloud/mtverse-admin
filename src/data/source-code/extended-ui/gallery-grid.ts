...
export const gallerygridSource: ComponentSourceData = {
  component: 'Gallery Grid',
  slug: 'gallery-grid',
  category: 'Extended UI',
  categorySlug: 'extended-ui',
  description: 'Responsive image gallery grid with lightbox preview and lazy loading.',
  sources: {
    react: {
      language: 'tsx',
      filename: 'GalleryGrid.tsx',
...
export default function GalleryGrid() {
  ...
  return (
    ...
    >
      <p className="text-sm text-gray-700 dark:text-gray-300">Responsive image gallery grid with lightbox preview and lazy loading.</p>
      <button
    ...
    nextjs: {
      language: 'tsx',
      filename: 'gallery-grid/page.tsx',
      code: `'use client';

import GalleryGrid from '@/components/mtverse/extended-ui/GalleryGrid';
...
export default function GalleryGridPage() {
  return (
    ...
    vue: {
      language: 'vue',
      filename: 'GalleryGrid.vue',
      code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    <p class="text-sm text-gray-700 dark:text-gray-300">Responsive image gallery grid with lightbox preview and lazy loading.</p>
    <button
...
const isActive = ref(false);
    ...
    angular: {
      language: 'ts',
      filename: 'gallery-grid.component.ts',
...
<div x-data="{ isActive: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <button
    ...
    laravel: {
      language: 'blade',
      filename: 'gallery-grid.blade.php',
