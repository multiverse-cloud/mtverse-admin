...
export const passwordStrengthSource: ComponentSourceData = {
  component: 'Password Strength',
  slug: 'password-strength',
  category: 'UI Elements',
  categorySlug: 'ui-elements',
  description: 'Password Strength component for the UI Elements library with full customization support.',
  sources: {
    react: { language: 'tsx', filename: 'PasswordStrength.tsx', code: `import React, { useState } from 'react';
    ...
    <div className="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
      ...
      {active && (
        <div className="mt-3 rounded-md bg-gray-50 p-3 dark:bg-white/5">
          <p className="text-xs text-gray-600 dark:text-gray-400">Interactive password strength content</p>
        </div>
      )}
    </div>
  );
}` },
    nextjs: { language: 'tsx', filename: 'password-strength/page.tsx', code: `'use client';
import PasswordStrength from '@/components/mtverse/ui-elements/PasswordStrength';
export default function Page() {
  return <PasswordStrength />;
}` },
    vue: { language: 'vue', filename: 'PasswordStrength.vue', code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    ...
    <div v-if="active" class="mt-3 rounded-md bg-gray-50 p-3 dark:bg-white/5">
      <p class="text-xs text-gray-600 dark:text-gray-400">Interactive password strength content</p>
    </div>
  </div>
</template>
...
const active = ref(false);
    ...
    angular: { language: 'ts', filename: 'password-strength.component.ts', code: `import { Component } from '@angular/core';
@Component({
...
export class PasswordStrengthComponent {
  ...
  toggle() { this.active = !this.active; }
    ...
    html: { language: 'html', filename: 'password-strength.html', code: `<!-- HTML + Alpine.js -->
<div x-data="{ active: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <div x-show="active" x-transition class="mt-3 rounded-md bg-gray-50 p-3 dark:bg-white/5">
    ...
    laravel: { language: 'blade', filename: 'password-strength.blade.php', code: `<!-- Laravel Blade + Alpine.js -->
<div x-data="{ active: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  <div class="flex items-center justify-between">
    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Password Strength</span>
    <button @click="active = !active"
