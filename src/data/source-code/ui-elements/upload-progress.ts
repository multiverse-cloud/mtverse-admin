...
export const uploadProgressSource: ComponentSourceData = {
  component: 'Upload Progress',
  slug: 'upload-progress',
  category: 'UI Elements',
  categorySlug: 'ui-elements',
  description: 'Upload Progress component for the UI Elements library with full customization support.',
  sources: {
    react: { language: 'tsx', filename: 'UploadProgress.tsx', code: `import React, { useState } from 'react';
    ...
    <div className="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
      ...
      {active && (
        <div className="mt-3 rounded-md bg-gray-50 p-3 dark:bg-white/5">
          <p className="text-xs text-gray-600 dark:text-gray-400">Interactive upload progress content</p>
        </div>
      )}
    </div>
  );
}` },
    nextjs: { language: 'tsx', filename: 'upload-progress/page.tsx', code: `'use client';
import UploadProgress from '@/components/mtverse/ui-elements/UploadProgress';
export default function Page() {
  return <UploadProgress />;
}` },
    vue: { language: 'vue', filename: 'UploadProgress.vue', code: `<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
    ...
    <div v-if="active" class="mt-3 rounded-md bg-gray-50 p-3 dark:bg-white/5">
      <p class="text-xs text-gray-600 dark:text-gray-400">Interactive upload progress content</p>
    </div>
  </div>
</template>
...
const active = ref(false);
    ...
    angular: { language: 'ts', filename: 'upload-progress.component.ts', code: `import { Component } from '@angular/core';
@Component({
...
export class UploadProgressComponent {
  ...
  toggle() { this.active = !this.active; }
    ...
    html: { language: 'html', filename: 'upload-progress.html', code: `<!-- HTML + Alpine.js -->
<div x-data="{ active: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  ...
  <div x-show="active" x-transition class="mt-3 rounded-md bg-gray-50 p-3 dark:bg-white/5">
    ...
    laravel: { language: 'blade', filename: 'upload-progress.blade.php', code: `<!-- Laravel Blade + Alpine.js -->
<div x-data="{ active: false }" class="rounded-lg border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-800">
  <div class="flex items-center justify-between">
    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Upload Progress</span>
    <button @click="active = !active"
